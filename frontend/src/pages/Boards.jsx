...
const Boards = () => {
  ...
  const handleToggleFavorite = async (e, board) => {
    ...
    try {
      await axios.put(`https://trellooo.onrender.com/boards/${board.id}/favorite`, { is_favorite: newFavStatus });
  ...
  const handleRenameBoardSubmit = async () => {
    ...
    try {
      await axios.put(`https://trellooo.onrender.com/boards/${boardToRename.id}`, { title: renameBoardTitle });
  ...
  const handleDeleteBoard = async (e, boardId) => {
    ...
    if (window.confirm('Are you sure you want to delete this board and all its nested lists/cards?')) {
      try {
        await axios.delete(`https://trellooo.onrender.com/boards/${boardId}`);
  ...
  const handleCreateBoard = async () => {
    ...
    try {
      const response = await axios.post('https://trellooo.onrender.com/boards', { 
        title: newBoardTitle, 
        owner_id: user.id 
      });
